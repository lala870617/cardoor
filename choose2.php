    ...
    <section id="service-area" class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <h3 style="font-family: 微軟正黑體">請填入選車之詳細資訊</h3>
                        <span class="title-line"><i class="fa fa-car"></i></span>
                    </div>
                    <div class="row">
                        ...
                        <div class="book-a-car" style="margin: 10px">
                            <form action="choose3.php" method="post">
                                    ...
                                    <div class="choose-car-type book-item">
                                        <h4 style="font-family: 微軟正黑體; font-weight: bold;">選擇取車地點:</h4>
                                        <div id="zipcode3">
                                        ...
                                        <!-- <textarea style="border-color: #ffd000" name="place" rows="4" cols="61" class="input_location"></textarea> -->
                                    </div>

                                    <!--== Pick Up Date ==-->

                                    <div class="pick-up-date book-item">
                                        <h4 style="font-family: 微軟正黑體; font-weight: bold; margin-top:100px">選擇取車日期:</h4>
                                        <input name="date" id="startDate" placeholder="Pick Up Date" />
                                    </div>
                                    <!--== Pick Up Location ==-->
                                    <div class="choose-car-type book-item">
                                        <h4 style="font-family: 微軟正黑體; font-weight: bold;">選擇取車時間:</h4>
