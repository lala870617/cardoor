                    ...
                    <div class="contact-form">
                        <form action="index.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="subject-input">
                                        <label><b>密碼</b></label>
                                        <div class="textinput"><?php echo $row['u_password']; ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6">
                                  <div class="message-input">
                                    ...
                                    <select class="custom-select textinput">

                                      <option selected>請選擇</option>
                                      <option selected><?php echo $row['u_sex']; ?></option>
                                      <option value="2">女</option>
                                      <option value="3">無性別</option>
                                    </select>
                                  </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                          ...
                          <div class="input-submit">
          									<button type="submit"><i class="fa fa-check-square"></i> 修改資料</button>
          								</div>
                            <!-- <div class="input-submit">
