            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="car-details-content">
                        <h2 style="font-family:'微軟正黑體'">若遇車故，該如何處理損害賠償？</h2>
                        <div class="car-preview-crousel">
                            <div class="single-car-preview">
                                <img src="assets/img/article/car.jpg" alt="JSOFT">
                            </div>
                            <div class="single-car-preview">
                                <img src="assets/img/article/insurance.jpg" alt="JSOFT">
                            </div>
                            <div class="single-car-preview">
                                <img src="assets/img/article/rescue.jpg" alt="JSOFT">
                            </div>
                        </div>
                        <div class="car-details-info blog-content">
                            <p>若您在租車服務期間，不幸遇到車禍意外，請立刻依照下列敘述：</p>


                            <p>首先要立刻報警或報緊急電話(110或119)，以及撥打我們的客服電話，讓我們立刻接收您的租車現況。</p>

                            <p class="thme-blockquote">請注意：若如果您沒有主動撥打客服電話，您將會損失本公司提供的部份保障設施。</p>

                            <p>撥打電話後，將依事件情況作一定的民事或刑事處理。</p>
